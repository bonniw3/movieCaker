...
(function(a) {
    ...
    function m(c, e) {
        ...
        b.prev('.verify-input').removeClass("field-validation-valid").addClass("field-validation-error");
    ...
    function k(d) {
        ...
        if (b) {
            b.prev('.verify-input').addClass("field-validation-valid").removeClass("field-validation-error");
